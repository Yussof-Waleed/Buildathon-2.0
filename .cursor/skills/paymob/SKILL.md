...
name: paymob
description: >-
  Integrates Paymob payments via Intention API, Unified Checkout, HMAC webhooks,
  and mobile SDKs. Use when the user mentions Paymob, checkout, payment gateway,
  HMAC, webhooks, Unified Checkout, or integrating payments in Egypt, UAE, KSA,
  or Oman.
---

# Paymob Payment Gateway Integration

This skill guides an AI coding agent (Cursor, Claude Code, Codex, Replit, Lovable, etc.) through integrating a merchant's project with **Paymob**, covering Shopify app installation, the **Intention API** for web/backend (via **Unified Checkout**), and **Mobile SDKs** for native iOS/Android/Flutter/React Native apps. Paymob operates in **Egypt, UAE, KSA, and Oman**.
